...
Run:  uv run python -m experiments.avsl.risk_overlay.risk_overlay
"""
...
from experiments.avsl.cross_confirm.avsl_cross_confirm import (
    ANN,
    NW_LAGS,
    _collect,
    _nw_sharpe,
)
from experiments.avsl.cross_confirm.avsl_cross_confirm2 import (
    HORIZON,
    RISK_PCT,
    _block_boot_mean_ci,
)
from experiments.avsl.cross_tf.avsl_cross_tf import ASSETS, _read_1h, _resample_4h
