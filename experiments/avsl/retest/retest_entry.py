...
Run:
  uv run python -m experiments.avsl.retest.retest_entry zscore   # E6
  uv run python -m experiments.avsl.retest.retest_entry donchian # E7
  uv run python -m experiments.avsl.retest.retest_entry ob       # E8
"""
...
def _ob_events(env: dict) -> tuple[np.ndarray, np.ndarray]:
    ...
    from experiments.ob.detector.research_presets import R2
