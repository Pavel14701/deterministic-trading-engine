...
Usage:
  python -m experiments.options.deribit_data.deribit_fetch instruments
  python -m experiments.options.deribit_data.deribit_fetch dvol
  python -m experiments.options.deribit_data.deribit_fetch trades --file list.txt
"""
