...
from engine.protocol import load_asset as protocol_load_asset  # noqa: E402
from engine.sim import sim  # noqa: E402
...
def lgb_ranker(tr_ix):
    return train_ranker(TAB_ALL, Y_ALL, ROW_ALL, tr_ix)
...
for fi, (fs, fe) in enumerate(folds):
    tr_mask, te_mask = fold_masks(TS_ALL, fs, fe)
