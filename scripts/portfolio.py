"""D.2: portfolio layer on WF-B trade series (BTC+ETH+SOL).
(formerly ``scripts/d9_portfolio.py``; output artifacts keep the
...
(REPO / "runs" / "d9_portfolio.json").write_text(json.dumps(out, indent=1))
print("saved runs/d9_portfolio.json")
