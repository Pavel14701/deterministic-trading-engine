"""D.13: OB/AVSL ablation - decompose the stack edge (+0.44R test pess).
...
from scripts.build_mtf_dataset import (  # noqa: E402
    LTF_BAR,
    _anchors_nan_safe,
    _entry_feature_row,
    _htf_asof_state,
...
from scripts.build_stop_dataset import STOP_PANEL  # noqa: E402
...
def main() -> None:
    ...
    print("\n=== D.13 ABLATION: contribution to test pess R ===", flush=True)
    desc = {
        "A": "OB + AVSL (control)",
        "B": "placebo OB + AVSL",
        "C": "real OB, AVSL off",
