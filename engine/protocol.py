...
from engine.sim import pess, sim
...
FOLD_DAYS = 56
EMBARGO_DAYS = 7
#: hold window (bars) handed to :func:`engine.sim.sim`
SIM_HOLD = 48
...
def load_panel(
    ...
    the main ``data/mtf_dataset`` panel (D.8b layout).
    """
...
def fold_masks(
    ...
    fitter leaks future folds (the D.13e audit finding).
    """
