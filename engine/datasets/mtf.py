...
from engine.datasets.okx import (  # noqa: E402
    detect_order_blocks,
    get_source,
    resolve_assets,
)
from engine.datasets.stops import (  # noqa: E402
    FEATURE_ANCHORS,
    STOP_PANEL,
    TARGET_PANEL,
    _excursions,
...
from engine.features.indicators import compute_atr  # noqa: E402
from engine.features.mtf import asof_rows, resample_ohlcv  # noqa: E402
from engine.features.panel import (  # noqa: E402
    assign_splits,
    limit_fill,
    nearest_zone_dists,
    rolling_percentile,
...
from engine.infra.config import load_config  # noqa: E402
from engine.structure.candidates import collect_candidates  # noqa: E402
from engine.structure.zones import (  # noqa: E402
    ...
    for exec_mode in EXECUTIONS:
        ...
        for rule, (tp_arr, sl_arr) in rule_levels.items():
            ...
            for target in TARGET_PANEL:
                ...
                if sign * (fill - sl_i) < 0:
                    # wrong-side stop - the entry (next open, with
