...
> Mandatory reading before editing/writing any test. Introduced by TZ-14 (null stage).
> A violation = PR rejection.
...
## 6. Unified config (root pyproject.toml)
