...
| **AVS-channel S1** | PASS 5/5, LATENT | runner `experiments/avsl/channel/` (channel_breakout, бывш. avsr/) | execution-пререг (P4-EX паттерн) до капитала; R = ширина канала, EV не сравним с AVSL напрямую |
